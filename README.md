...
Runner game 2D développé en TypeScript avec Canvas 2D, inspiré du T-Rex Runner, dans un objectif pédagogique et progressif.
...
-Respawn à droite lorsqu’un obstacle sort de l’écran
-Plusieurs profils d’obstacles :
    obstacle au sol
    obstacle aérien (anti-saut)
Système extensible (long, rapide, patterns, etc.)
